import { serviceGetBookings, serviceGetBookingsTenant } from '@/services/booking.services';
...
export const getBookingsController = async (req: Request, res: Response) => {
  ...
  export const getBookingsTenantController = async (req: Request, res: Response) => {
